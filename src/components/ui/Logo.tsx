...
export const Logo: React.FC<LogoProps> = ({ className, showText = true, variant = 'dark', isBranded = false }) => {
  ...
  return (
    <div className={clsx("flex flex-col items-center justify-center relative", className)}>
      {/* MD Monogram SVG */}
      <svg 
        viewBox="0 0 100 80" 
        fill="none" 
        xmlns="http://www.w3.org/2000/svg"
        className={clsx("w-full h-full max-w-[120px] transition-transform duration-500", isBranded && "scale-110")}
      >
        {/* M Left Leg */}
        ...
        {/* Stylized Cuts/Accents for 3D feel */}
